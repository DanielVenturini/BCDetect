...
links=data.frame(
    ...
    target=c('Fixed by client (62.5%)', 'Fixed by provider (37.5%)', 'Fixed by client (67.6%)', 'Fixed by provider (24.3%)', 'Did not fixed (8.1%)', 'Updated provider (20%)', 'Provedor regredido (80%)', 'Updated provider (20.8%) ', 'Downgraded provider (66.7%)', 'Did not changed (12.5%)'),
